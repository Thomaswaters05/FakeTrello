...
namespace FakeTrello.Tests.DAL
{
    ...
    public class FakeTrelloRepoTests
    {
        ...
        {
            var query_boards = fake_board_table.AsQueryable(); // REXPRESS THIS LIST AS SOMETHING THAT UNDERSTANDS QUERIES 

            //HEY LINQ, use the Provider from our *cough* fake table/list
